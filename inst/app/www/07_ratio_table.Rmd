...
![Ratio table example](images/07_ratio_table_01.png)  
...
Thus, when reporting delta values of the samples, conversion of sample delta against reference metrial is performed using above equation. 
